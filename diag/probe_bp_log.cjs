...
(async () => {
  ...
  const expr = '({ installed: window.__ds_bp_input_installed, logLen: Array.isArray(window.__ds_bp_input_log) ? window.__ds_bp_input_log.length : null, log: Array.isArray(window.__ds_bp_input_log) ? window.__ds_bp_input_log.slice(-20) : null })';
